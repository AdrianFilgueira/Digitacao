...
namespace Digitação
{
    public partial class frmCadastro : Form
    {
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            dateTimePicker1.CustomFormat = "yyyy-dd-MM hh:mm:ss.mmm";
            
            string data = dateTimePicker1.Text;
            //MessageBox.Show("INSERT INTO aluno (nome, linhas, dataCad) VALUES ('" + txtNomeAluno.Text + "'" + ", " + nivel + ", '" + data + "')");
            sql.Insert("INSERT INTO aluno (nome, linhas, dataCad) VALUES ('" + txtNomeAluno.Text + "'" + ", " + nivel + ", '"+ data + "')");
            Close();
